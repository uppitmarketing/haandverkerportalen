    ...
    <Layout title="Om HåndverkerPortalen" description="HåndverkerPortalen er Norges håndverkerregister med data fra Brønnøysundregistrene.">
      <div className={styles.page}>
        <div className="container--narrow">
          ...
          <h2 className={styles.heading}>Hva er HåndverkerPortalen?</h2>
          <p className={styles.tekst}>Vi samler og presenterer data fra Brønnøysundregistrene for å gjøre det enkelt å finne riktig håndverker i din kommune. Alle bedrifter er verifisert mot offentlige registre.</p>

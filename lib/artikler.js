...
export const ARTIKLER = [
  ...
  },
  {
    ...
    seksjoner: [
      ...
      },
      {
        ...
        avsnitt: [
          'Sjekk at bedriften har ansvarsforsikring, og avklar hvilke garantier som gjelder på utført arbeid. Ved oppføring av bolig gjelder bustadoppføringslova, som blant annet gir deg krav på garanti fra entreprenøren i en periode etter overtakelse — spør spesifikt om dette før kontraktsinngåelse.',
        ],
      },
      {
        heading: 'Varselsignaler å se etter',
    ...
    faq: [
      ...
      },
      {
        ...
        sv: 'Ved kjøp av bolig fra profesjonell part gjelder bustadoppføringslova, som gir deg reklamasjonsrett i en periode etter overtakelse. Be om at garantivilkårene fremgår tydelig av kontrakten før arbeidet starter.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    seksjoner: [
      ...
      },
      {
        ...
        avsnitt: [
          'Takarbeid er høyderisikoarbeid, og bedriften skal følge regelverket for fallsikring ved arbeid i høyden. Spør om bedriften har ansvarsforsikring som dekker eventuelle skader på bygningen under arbeidet, i tillegg til garanti på selve taktekkingen.',
        ],
      },
      {
        heading: 'Varselsignaler å se etter',
  ...
  },
  {
    ...
    seksjoner: [
      {
        heading: 'Sjekk fagbrev i mur- og betongfaget',
        avsnitt: [
          'Fagbrev i mur- og betongfaget er ikke lovpålagt, men gir dokumentert kompetanse på materialvalg, fuktsikring og oppbygning — spesielt viktig ved grunnmur, pipe og fasadearbeid der feil kan gi frostskader eller fuktinntrenging som først vises år senere.',
    ...
    faq: [
      {
        ...
        sv: 'Nei, det er ikke et lovkrav. Fagbrev i mur- og betongfaget er likevel et godt tegn på kompetanse, spesielt ved grunnmur og pipearbeid der feil kan gi kostbare fukt- og frostskader.',
      },
      {
